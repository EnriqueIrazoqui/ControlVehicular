...
const NuevaSalida = () => {
  ...
  const guardar = async(e) => {
    e.preventDefault();
      ...
      const {datos} = await Peticiones(Global.url+"prestamoVehicularSalida", "POST", nuevo);
          ...
          <div className="inputs">
              ...
              <div className="inputs">
                <p className='parrafo'>
                  ...
                  <input className='input' type="text" name="extras" id="extras" required="obligatorio" placeholder="Ej: vehiculo sucio" onChange={cambiado} />
                </p>
                <p className='parrafo'>
