...
const { post_refrendos, get_refrendos,get_refrendo,get_busqueda, put_refrendos, delete_refrendos } = require('../controllers/refrendos_controller.js');
...
router.get('/:idRefrendo',
    param('idRefrendo').exists().notEmpty().isString(),
    get_refrendo);
