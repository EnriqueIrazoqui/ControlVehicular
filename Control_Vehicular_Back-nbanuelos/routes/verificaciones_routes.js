...
const { post_verificaciones, get_verificaciones,get_verificacion,get_busqueda, put_verificaciones, delete_verificaciones } = require('../controllers/verificaciones_controller.js');
...
router.get('/:idVerificacion',
    param('idVerificacion').exists().notEmpty().isString(),
    get_verificacion);
